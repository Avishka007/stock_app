...
d = [98.161552,95.772095,100.700043,96.621567,96.129768,93.665794,96.298668,96.899757,96.144669,97.058723,97.03389,99.338898,101.291199,98.01252,96.333443,93.53167,89.776093,87.987724,94.008568,93.432312,94.555008,97.177948,95.329971,102.314545,104.748711,101.519714,97.38163,98.678192,95.171005,93.382637,93.094513,95.871452,96.984215,98.563934,98.310585,98.335426,95.066681,96.348351,93.834694,92.33445,93.387604,92.428841,91.991684,92.900772,92.349358,93.794952,92.001617,90.089058,89.408485,88.325531]
xs = np.array(list(range(0, 50)))
ys = np.array(d)
def best_fit_slope(xs,ys):
    m = (((mean(xs)*mean(ys)) - mean(xs*ys)) /
    ...
    return m
m = best_fit_slope(xs,ys)
print(m*100,"\t: is the m value of slope 000")
